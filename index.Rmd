...
From table \@ref(tab:best-restaurant) above, there are twelve restaurants which have minimum rating 4.8 out of 5 hence can be described as the very best restaurants in Melbourne. The prices, cuisines and locations in the top list vary but with some patterns that will be further explored in the following section.
...
glute_kable <- glute %>%
  ...
  kable_styling(latex_options= c("striped", "condensed", "hold_position"), full_width = F,stripe_color  = "pink", font_size = 8) 
...
The Table \@ref(tab:rest-gluten-free) shows the name of the restaurants in Melbourne, their locality, number of reviews received, aggregate ratings, photo count and how much it costs for one persons gluten free meal on average. 
