...
The graph Figure \@ref(fig:review_price relation) shows top restaraunts in Melbourne, using the category "gluten free", with an intercept at 500 reviews count. In the highest rating of 4.9, Lune Croissanterie is the best restaraunt with very reasonable average price of __$__ 12.50  per person. While, Vue de monde is second on the list with a rating of 4.8 but very pricy at an average cost of __$__ 300.
