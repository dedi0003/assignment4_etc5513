...
```{r , include=FALSE}
gl <- zomato$new("1623b413d3a1614e765de7578f83a10b") 
```
...
```{r}
glu <- gl$search(entity_id = "259", entity_type = "city", category = "Gluten-Free")
```
...
```{r good restaraunt gluten free, fig.cap = "Top options"}
...
```{r review_price relation, fig.cap= "Worth the money!"}
