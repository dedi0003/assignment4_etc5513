...
mapshot(map_testcon, file = paste0(getwd(), "/map_icon.jpeg"))
...
The Table \@ref(tab:good-restaraunt-gluten-free) shows the name of the restarunts in Melbourne, their locality, number of reviews recieved, aggregate ratings, photo count and how much it costs for one persons gluten free meal on average. 
