...
map_melb <- leaflet(melb_best) %>%
  ...
  setView(lng = 144.946457, lat = -37.840935, zoom = 12) #Vic map
...
There are ten restaurants which have rating equals and more than 4.8 hence can be categorised as best of the best in Melbourne.
