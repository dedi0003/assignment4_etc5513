...
In this section we will be looking into restarunts with gluten free food.  
...
gluten <- ggplot(glute,  
  ...
  geom_point(color = "midnightblue") +
   facet_wrap(~aggregate_rating) + geom_vline(xintercept = 500, color = "red")+theme(legend.position = "none")
